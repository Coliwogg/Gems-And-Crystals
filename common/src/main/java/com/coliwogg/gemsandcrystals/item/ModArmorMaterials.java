...
public class ModArmorMaterials {
    ...
    public static final Holder<ArmorMaterial> EMERALD = register("emerald", Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
    ...
    public static final Holder<ArmorMaterial> TOPAZ = register("topaz", Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
        attribute.put(ArmorItem.Type.BOOTS, 2);
        attribute.put(ArmorItem.Type.LEGGINGS, 6);
        attribute.put(ArmorItem.Type.CHESTPLATE, 8);
        attribute.put(ArmorItem.Type.HELMET, 3);
    ...
    public static final Holder<ArmorMaterial> AMETHYST = register("amethyst", Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
        attribute.put(ArmorItem.Type.BOOTS, 2);
    ...
    public static final Holder<ArmorMaterial> QUARTZ = register("quartz", Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
        ...
        ResourceLocation location = GemsAndCrystals.identifier(name);
