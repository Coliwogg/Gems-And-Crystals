...
public class GemsAndCrystals {
    ...
    public GemsAndCrystals(IEventBus modEventBus, ModContainer modContainer) {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        if (event.getTabKey() == CreativeModeTabs.COMBAT) {
            ...
            event.accept(ModItems.RUBY_SPEAR);
            event.accept(ModItems.SAPPHIRE_SPEAR);
            event.accept(ModItems.EMERALD_SPEAR);
            event.accept(ModItems.TOPAZ_SPEAR);
            event.accept(ModItems.AMETHYST_SPEAR);
            event.accept(ModItems.QUARTZ_SPEAR);
