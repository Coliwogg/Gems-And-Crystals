...
public enum OreType {
    ...
    QUARTZ(Lazy.of(BlockInit.QUARTZ_ORE), Lazy.of(BlockInit.DEEPSLATE_QUARTZ_ORE), OreGenConfig.quartz_min_vein_size.get(), OreGenConfig.quartz_max_vein_size.get(), OreGenConfig.quartz_min_height.get(), OreGenConfig.quartz_max_height.get(), OreGenConfig.quartz_chance.get(), OreGenConfig.generate_quartz.get());
    ...
    OreType(Lazy<Block> block, Lazy<Block> deepslateBlock, int minVeinSize, int maxVeinSize, int minHeight, int maxHeight, int chance, boolean generateOreToggle) {
        this.block = block;
