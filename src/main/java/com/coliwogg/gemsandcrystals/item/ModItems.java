...
public class ModItems {
    ...
    public static final DeferredItem<Item> TOPAZ_SWORD = ITEMS.registerItem("topaz_sword", (properties) -> new Item(properties.sword(ModToolTiers.TOPAZ, 3, -2.4f)));
    ...
    public static final DeferredItem<Item> AMETHYST_SWORD = ITEMS.registerItem("amethyst_sword", (properties) -> new Item(properties.sword(ModToolTiers.AMETHYST, 2, -2.4f)));
