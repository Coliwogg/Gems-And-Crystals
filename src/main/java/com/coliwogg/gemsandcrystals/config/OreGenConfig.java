...
public class OreGenConfig {
	...
	public static void init(ForgeConfigSpec.Builder server, ForgeConfigSpec.Builder client) {
		...
		ruby_chance = server.comment("Maximum number of ore veins of ruby ore that can spawn in one chunk").defineInRange("oregen.ruby_chance", 7, 6, 9);
		sapphire_chance = server.comment("Maximum number of ore veins of sapphire ore that can spawn in one chunk").defineInRange("oregen.sapphire_chance", 7, 6, 9);
