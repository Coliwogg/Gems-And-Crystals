...
//                .defineInRange("oregen.ruby_ore.ruby_chance", 2, 0, 100);

        ruby_min_height = server
                .comment("Minimum height for Ruby Ore generation - default = 4")
                .defineInRange("oregen.ruby_ore.ruby_min_height", 4, 0, 255);

        ruby_max_height = server
                .comment("Maximum height for Ruby Ore generation - default = 15")
                .defineInRange("oregen.ruby_ore.ruby_max_height", 15, 0, 255);
...
//                .defineInRange("oregen.sapphire_ore.sapphire_chance", 2, 0, 100);

        sapphire_min_height = server
                .comment("Minimum height for Sapphire Ore generation - default = 4")
                .defineInRange("oregen.sapphire_ore.sapphire_min_height", 4, 0, 255);

        sapphire_max_height = server
                .comment("Maximum height for Sapphire Ore generation - default = 15")
                .defineInRange("oregen.sapphire_ore.sapphire_max_height", 15, 0, 255);
...
//                .defineInRange("oregen.topaz_ore.topaz_chance", 3, 0, 100);

        topaz_min_height = server
                .comment("Minimum height for Topaz Ore generation - default = 4")
                .defineInRange("oregen.topaz_ore.topaz_min_height", 4, 0, 255);

        topaz_max_height = server
                .comment("Maximum height for Topaz Ore generation - default = 23")
                .defineInRange("oregen.topaz_ore.topaz_max_height", 23, 0, 255);
        ...
        amethyst_min_vein_size = server
                .comment("Minimum size of Amethyst Ore veins - default = 3")
                .defineInRange("oregen.amethyst_ore.amethyst_min_vein_size", 3, 0, 100);
...
//                .defineInRange("oregen.amethyst_ore.amethyst_chance", 3, 0, 100);
        ...
        amethyst_max_height = server
                .comment("Maximum height for Amethyst Ore generation - default = 31")
                .defineInRange("oregen.amethyst_ore.amethyst_max_height", 31, 0, 255);
...
//                .defineInRange("oregen.quartz_ore.quartz_chance", 4, 0, 100);

        quartz_min_height = server
                .comment("Minimum height for Quartz Ore generation - default = 4")
                .defineInRange("oregen.quartz_ore.quartz_min_height", 4, 0, 255);

        quartz_max_height = server
                .comment("Maximum height for Quartz Ore generation - default = 39")
                .defineInRange("oregen.quartz_ore.quartz_max_height", 39, 0, 255);
